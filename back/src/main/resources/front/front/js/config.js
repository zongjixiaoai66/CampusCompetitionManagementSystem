...
var centerMenu = [
    ...
    ,{
        name: '获奖名单',
        url: '../jingsaiHuojiangmingdan/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '学习指导',
        url: './pages/xuexizhidao/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/xiaoyuanjingsai/admin/dist/index.html#/login";
