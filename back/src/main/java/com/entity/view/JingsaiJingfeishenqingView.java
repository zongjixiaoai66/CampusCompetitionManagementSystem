...
public class JingsaiJingfeishenqingView extends JingsaiJingfeishenqingEntity implements Serializable {
	...
	* 经费类型的值
	*/
	@ColumnInfo(comment="经费类型的字典表值",type="varchar(200)")
	private String jingsaiJingfeishenqingValue;
	/**
	* 申请状态的值
	*/
	@ColumnInfo(comment="申请状态的字典表值",type="varchar(200)")
	private String jingsaiJingfeishenqingYesnoValue;
	...
	public JingsaiJingfeishenqingView() {

	}

	public JingsaiJingfeishenqingView(JingsaiJingfeishenqingEntity jingsaiJingfeishenqingEntity) {
		try {
			BeanUtils.copyProperties(this, jingsaiJingfeishenqingEntity);
	...
	* 获取： 经费类型的值
	*/
	public String getJingsaiJingfeishenqingValue() {
		return jingsaiJingfeishenqingValue;
	}
	/**
	* 设置： 经费类型的值
	*/
	public void setJingsaiJingfeishenqingValue(String jingsaiJingfeishenqingValue) {
		this.jingsaiJingfeishenqingValue = jingsaiJingfeishenqingValue;
	}
	//当前表的
	/**
	* 获取： 申请状态的值
	*/
	public String getJingsaiJingfeishenqingYesnoValue() {
		return jingsaiJingfeishenqingYesnoValue;
	}
	/**
	* 设置： 申请状态的值
	*/
	public void setJingsaiJingfeishenqingYesnoValue(String jingsaiJingfeishenqingYesnoValue) {
		this.jingsaiJingfeishenqingYesnoValue = jingsaiJingfeishenqingYesnoValue;
	}
	...
	public String toString() {
		return "JingsaiJingfeishenqingView{" +
			", jingsaiJingfeishenqingValue=" + jingsaiJingfeishenqingValue +
			", jingsaiJingfeishenqingYesnoValue=" + jingsaiJingfeishenqingYesnoValue +
