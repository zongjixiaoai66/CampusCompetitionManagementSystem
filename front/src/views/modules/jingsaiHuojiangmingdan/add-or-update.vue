    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="jingsaiId" name="jingsaiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="获奖名单编号" prop="jingsaiHuojiangmingdanUuidNumber">
                       <el-input v-model="ruleForm.jingsaiHuojiangmingdanUuidNumber"
                                 placeholder="获奖名单编号" clearable  :readonly="ro.jingsaiHuojiangmingdanUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="获奖名单编号" prop="jingsaiHuojiangmingdanUuidNumber">
                           <el-input v-model="ruleForm.jingsaiHuojiangmingdanUuidNumber"
                                     placeholder="获奖名单编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.jingsaiHuojiangmingdanContent"  label="名单详情" prop="jingsaiHuojiangmingdanContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.jingsaiHuojiangmingdanContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jingsaiHuojiangmingdanContent" label="名单详情" prop="jingsaiHuojiangmingdanContent">
                            <span v-html="ruleForm.jingsaiHuojiangmingdanContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    jingsaiId: false,
                    jingsaiHuojiangmingdanUuidNumber: false,
                    jingsaiHuojiangmingdanContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    jingsaiId: '',
                    jingsaiHuojiangmingdanUuidNumber: new Date().getTime(),
                    jingsaiHuojiangmingdanContent: '',
                    insertTime: '',
                },
                jingsaiOptions : [],
                rules: {
                   ...
                   jingsaiHuojiangmingdanUuidNumber: [
                              { required: true, message: '获奖名单编号不能为空', trigger: 'blur' },
                          ],
                   jingsaiHuojiangmingdanContent: [
                              { required: true, message: '名单详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
                              { required: true, message: '法布时间不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `jingsaiHuojiangmingdan/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.jingsaiChange(data.data.jingsaiId)
                        _this.ruleForm.jingsaiHuojiangmingdanContent = _this.ruleForm.jingsaiHuojiangmingdanContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.jingsaiHuojiangmingdanContent = this.ruleForm.jingsaiHuojiangmingdanContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`jingsaiHuojiangmingdan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jingsaiHuojiangmingdanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
